(function(g){var window=this;'use strict';var pYa=function(a,b,c){null!=c&&(g.vd(a,b,1),a=a.i,b=c>>>0,c=Math.floor((c-b)/4294967296)>>>0,g.Ie=b,g.He=c,g.td(a,g.Ie),g.td(a,g.He))},qYa=function(a,b,c){b=g.Jd(b,c);
null!=b&&(g.vd(a,c,0),a.i.i.push(b?1:0))},rYa=function(a,b){return g.Af(a,b)},sYa=function(a,b){b=b instanceof g.Bg?b:g.Hg(b,/^data:image\//i.test(b));
a.src=g.Cg(b)},uYa=function(a){g.F.call(this,a,-1,tYa)},vYa=function(a){g.F.call(this,a)},yYa=function(){return[1,
wYa,2,xYa]},zYa=function(){return[1,
g.nr,vYa,yYa]},AYa=function(a){g.F.call(this,a)},BYa=function(a){g.F.call(this,a)},DYa=function(){return[1,
g.pr,2,g.pr,3,CYa]},EYa=function(a){g.F.call(this,a)},GYa=function(){return[1,
g.pr,2,g.pr,3,FYa,4,CYa]},IYa=function(){return[1,
g.We,BYa,DYa,HYa,2,g.We,EYa,GYa,HYa]},MYa=function(){return[1,
JYa,g.Wi,2,KYa,g.Wi,3,LYa,g.Wi]},PYa=function(){return[1,
NYa,g.Vi,2,OYa,g.Vi,3,g.We,uYa,zYa,g.Vi]},RYa=function(){return[1,
g.nr,g.Si,MYa,2,QYa,g.Ti,PYa]},VYa=function(){return[1,
g.pr,5,SYa,2,QYa,AYa,IYa,3,TYa,6,UYa,4,g.nr,g.Ri,RYa]},W6=function(a){g.Il(a,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^g.Va()).toString(36));
return a},X6=function(a,b,c){Array.isArray(c)||(c=[String(c)]);
g.Nl(a.j,b,c)},WYa=function(a){if(a===g.Ho)throw Error("ES6 Iteration protocol does NOT adjust control flow when StopIteration is thrown from callback helper functions. If your code relies on this behavior, consider throwing a different error and catching it to terminate iteration.");
throw a;},XYa=function(a){if(a instanceof g.Fo)return a;
...
return c}throw Error("Not implemented");},YYa=function(a,b,c){if(g.Pa(a))try{g.yc(a,b,c)}catch(e){WYa(e)}else for(a=XYa(a);;){var d=void 0;
try{d=a.Nj()}catch(e){if(e===g.Ho)break;throw e;}try{b.call(c,d,void 0,a)}catch(e){WYa(e)}}},ZYa=function(a,b){var c=[];
YYa(b,function(d){try{var e=g.Xq.prototype.j.call(this,d,!0)}catch(f){if("Storage: Invalid value was encountered"==f)return;throw f;}void 0===e?c.push(d):g.Zga(e)&&c.push(d)},a);
return c},$Ya=function(a,b){ZYa(a,b).forEach(function(c){g.Xq.prototype.remove.call(this,c)},a)},aZa=function(a){if(a.oa){if(a.oa.locationOverrideToken)return{locationOverrideToken:a.oa.locationOverrideToken};
if(null!=a.oa.latitudeE7&&null!=a.oa.longitudeE7)return{latitudeE7:a.oa.latitudeE7,longitudeE7:a.oa.longitudeE7}}return null},bZa=function(a,b){g.bc(a,b)||a.push(b)},Y6=function(a){var b=0,c;
for(c in a)b++;return b},cZa=function(a){try{return g.C.JSON.parse(a)}catch(b){}a=String(a);
if(/^\s*$/.test(a)?0:/^[\],:{}\s\u2028\u2029]*$/.test(a.replace(/\\["\\\/bfnrtu]/g,"@").replace(/(?:"[^"\\\n\r\u2028\u2029\x00-\x08\x0a-\x1f]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?)[\s\u2028\u2029]*(?=:|,|]|}|$)/g,"]").replace(/(?:^|:|,)(?:[\s\u2028\u2029]*\[)+/g,"")))try{return eval("("+a+")")}catch(b){}throw Error("Invalid JSON string: "+a);},Z6=function(a){if(g.C.JSON)try{return g.C.JSON.parse(a)}catch(b){}return cZa(a)},dZa=function(a,b,c,d){var e=new g.rl(null,void 0);
...
a.user||"",this.avatar=a.userAvatarUri||"",this.obfuscatedGaiaId=a.obfuscatedGaiaId||"",this.theme=a.theme||"u",eZa(this,a.capabilities||""),fZa(this,a.experiments||""),this.brand=a.brand||"",this.model=a.model||"",this.year=a.year||0,this.os=a.os||"",this.osVersion=a.osVersion||"",this.chipset=a.chipset||"",this.mdxDialServerType=a.mdxDialServerType||"MDX_DIAL_SERVER_TYPE_UNKNOWN",a=a.deviceInfo)&&(a=JSON.parse(a),this.brand=a.brand||"",this.model=a.model||"",this.year=a.year||0,this.os=a.os||"",
this.osVersion=a.osVersion||"",this.chipset=a.chipset||"",this.clientName=a.clientName?a.clientName.toUpperCase():"UNKNOWN_INTERFACE",this.mdxDialServerType=a.mdxDialServerType||"MDX_DIAL_SERVER_TYPE_UNKNOWN")},eZa=function(a,b){a.capabilities.clear();
g.Mo(b.split(","),g.Ua(rYa,gZa)).forEach(function(c){a.capabilities.add(c)})},fZa=function(a,b){a.experiments.clear();
b.split(",").forEach(function(c){a.experiments.add(c)})},b7=function(a){a=a||{};
this.name=a.name||"";this.id=a.id||a.screenId||"";this.token=a.token||a.loungeToken||"";this.uuid=a.uuid||a.dialId||"";this.idType=a.screenIdType||"normal"},c7=function(a,b){return!!b&&(a.id==b||a.uuid==b)},hZa=function(a){return{name:a.name,
screenId:a.id,loungeToken:a.token,dialId:a.uuid,screenIdType:a.idType}},iZa=function(a){return new b7(a)},jZa=function(a){return Array.isArray(a)?g.vn(a,iZa):[]},d7=function(a){return a?'{name:"'+a.name+'",id:'+a.id.substr(0,6)+"..,token:"+((a.token?".."+a.token.slice(-6):"-")+",uuid:"+(a.uuid?".."+a.uuid.slice(-6):"-")+",idType:"+a.idType+"}"):"null"},e7=function(a){return Array.isArray(a)?"["+g.vn(a,d7).join(",")+"]":"null"},f7=function(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,
function(a){var b=16*Math.random()|0;
return("x"==a?b:b&3|8).toString(16)})},kZa=function(a){return g.vn(a,function(b){return{key:b.id,
name:b.name}})},g7=function(a,b){return g.Xb(a,function(c){return c||b?!c!=!b?!1:c.id==b.id:!0})},h7=function(a,b){return g.Xb(a,function(c){return c7(c,b)})},lZa=function(){var a=(0,g.Bx)();
a&&$Ya(a,a.i.Pg(!0))},i7=function(){var a=g.Ex("yt-remote-connected-devices")||[];
g.uc(a);return a},mZa=function(a){if(g.cc(a))return[];
var b=a[0].indexOf("#"),c=-1==b?a[0]:a[0].substring(0,b);return g.vn(a,function(d,e){return 0==e?d:d.substring(c.length)})},nZa=function(a){g.Dx("yt-remote-connected-devices",a,86400)},k7=function(){if(j7)return j7;
...
g.bc(a,b);g.Gx()&&g.xc(a,b);a=mZa(a);if(g.cc(a))try{g.Bka("remote_sid")}catch(c){}else try{g.ct("remote_sid",a.join(","),-1)}catch(c){}},oZa=function(){return g.Ex("yt-remote-session-browser-channel")},pZa=function(){return g.Ex("yt-remote-local-screens")||[]},qZa=function(){g.Dx("yt-remote-lounge-token-expiration",!0,86400)},rZa=function(a){5<a.length&&(a=a.slice(a.length-5));
var b=g.vn(pZa(),function(d){return d.loungeToken}),c=g.vn(a,function(d){return d.loungeToken});
g.wn(c,function(d){return!g.bc(b,d)})&&qZa();
g.Dx("yt-remote-local-screens",a,31536E3)},sZa=function(a,b){g.Dx("yt-remote-session-browser-channel",a);
g.Dx("yt-remote-session-screen-id",b);a=i7();b=k7();g.bc(a,b)||a.push(b);nZa(a);l7()},m7=function(a){a||(g.Fx("yt-remote-session-screen-id"),g.Fx("yt-remote-session-video-id"));
l7();a=i7();g.gc(a,k7());nZa(a)},tZa=function(){if(!n7){var a=g.fr();
a&&(n7=new g.Uq(a))}},uZa=function(){tZa();
return n7?!!n7.get("yt-remote-use-staging-server"):!1},o7=function(){var a=window.navigator.userAgent.match(/Chrome\/([0-9]+)/);
return a?parseInt(a[1],10):0},vZa=function(a){return!!document.currentScript&&(-1!=document.currentScript.src.indexOf("?"+a)||-1!=document.currentScript.src.indexOf("&"+a))},wZa=function(){return"function"==typeof window.__onGCastApiAvailable?window.__onGCastApiAvailable:null},p7=function(a){a.length?xZa(a.shift(),function(){p7(a)}):q7()},yZa=function(a){return"chrome-extension://"+a+"/cast_sender.js"},xZa=function(a,b,c){var d=document.createElement("script");
d.onerror=b;c&&(d.onload=c);g.Lk(d,g.Kq(a));(document.head||document.documentElement).appendChild(d)},zZa=function(){var a=o7(),b=[];
if(1<a){var c=a-1;b.push("//www.gstatic.com/eureka/clank/"+a+"/cast_sender.js");b.push("//www.gstatic.com/eureka/clank/"+c+"/cast_sender.js")}return b},q7=function(){var a=wZa();
a&&a(!1,"No cast extension found")},r7=function(){if(AZa){var a=2,b=wZa(),c=function(){a--;
0==a&&b&&b(!0)};
window.__onGCastApiAvailable=c;xZa("//www.gstatic.com/cast/sdk/libs/sender/1.0/cast_framework.js",q7,c)}},BZa=function(){r7();
var a=zZa();a.push("//www.gstatic.com/eureka/clank/cast_sender.js");p7(a)},DZa=function(){r7();
var a=zZa();a.push.apply(a,g.v(CZa.map(yZa)));a.push("//www.gstatic.com/eureka/clank/cast_sender.js");p7(a)},EZa=function(){this.i=s7();
this.i.Wy("/client_streamz/youtube/living_room/mdx/browser_channel/closed_channels")},FZa=function(){this.i=s7();
this.i.Wy("/client_streamz/youtube/living_room/mdx/browser_channel/pending_maps")},GZa=function(){this.i=s7();
...
return g.C.setTimeout(function(){a()},b)},z7=function(a){y7.dispatchEvent(new HZa(y7,a))},HZa=function(a,b){g.ef.call(this,"statevent",a);
this.stat=b},A7=function(a,b,c,d){this.i=a;
this.u=b;this.N=c;this.J=d||1;this.j=45E3;this.B=new g.Ol(this);this.I=new g.Fi;this.I.setInterval(250)},JZa=function(a,b,c){a.vu=1;
a.An=W6(b.clone());a.Qq=c;a.C=!0;IZa(a,null)},B7=function(a,b,c,d,e){a.vu=1;
a.An=W6(b.clone());a.Qq=null;a.C=c;e&&(a.UO=!1);IZa(a,d)},IZa=function(a,b){a.Ut=Date.now();
C7(a);a.Xo=a.An.clone();X6(a.Xo,"t",a.J);a.mC=0;a.Of=a.i.pE(a.i.Yx()?b:null);0<a.eD&&(a.wB=new u7((0,g.Ta)(a.TP,a,a.Of),a.eD));a.B.Pa(a.Of,"readystatechange",a.HR);b=a.yp?g.Hf(a.yp):{};a.Qq?(a.jC="POST",b["Content-Type"]="application/x-www-form-urlencoded",a.Of.send(a.Xo,a.jC,a.Qq,b)):(a.jC="GET",a.UO&&!g.jf&&(b.Connection="close"),a.Of.send(a.Xo,a.jC,null,b));a.i.Oj(1)},LZa=function(a,b){var c=a.mC,d=b.indexOf("\n",c);
if(-1==d)return D7;c=Number(b.substring(c,d));if(isNaN(c))return KZa;d+=1;if(d+c>b.length)return D7;b=b.substr(d,c);a.mC=d+c;return b},NZa=function(a,b){a.Ut=Date.now();
C7(a);var c=b?window.location.hostname:"";a.Xo=a.An.clone();g.Il(a.Xo,"DOMAIN",c);g.Il(a.Xo,"t",a.J);try{a.fk=new ActiveXObject("htmlfile")}catch(m){E7(a);a.pn=7;z7(22);F7(a);return}var d="<html><body>";if(b){var e="";for(b=0;b<c.length;b++){var f=c.charAt(b);if("<"==f)f=e+"\\x3c";else if(">"==f)f=e+"\\x3e";else{if(f in G7)f=G7[f];else if(f in MZa)f=G7[f]=MZa[f];else{var h=f.charCodeAt(0);if(31<h&&127>h)var l=f;else{if(256>h){if(l="\\x",16>h||256<h)l+="0"}else l="\\u",4096>h&&(l+="0");l+=h.toString(16).toUpperCase()}f=
...
a.j;
OZa(a,a.j)},OZa=function(a,b){if(null!=a.Iu)throw Error("WatchDog timer not null");
...
g.bf(a.wB);a.wB=null;a.I.stop();g.Ql(a.B);if(a.Of){var b=a.Of;a.Of=null;b.abort();b.dispose()}a.fk&&(a.fk=null)},I7=function(a,b){try{a.i.WN(a,b),a.i.Oj(4)}catch(c){}},QZa=function(a,b,c,d,e){if(0==d)c(!1);
else{var f=e||0;d--;PZa(a,b,function(h){h?c(!0):g.C.setTimeout(function(){QZa(a,b,c,d,f)},f)})}},PZa=function(a,b,c){var d=new Image;
...
sYa(d,a)},J7=function(a){a.onload=null;
a.onerror=null;a.onabort=null;a.ontimeout=null},RZa=function(a){this.i=a;
this.j=new w7},SZa=function(a){var b=K7(a.i,a.Fv,"/mail/images/cleardot.gif");
W6(b);QZa(b.toString(),5E3,(0,g.Ta)(a.wS,a),3,2E3);a.Oj(1)},M7=function(a){var b=a.i.W;
if(null!=b)z7(5),b?(z7(11),L7(a.i,a,!1)):(z7(12),L7(a.i,a,!0));else if(a.rh=new A7(a,void 0,void 0,void 0),a.rh.yp=a.fD,b=a.i,b=K7(b,b.Yx()?a.ov:null,a.gD),z7(5),!g.Oc||g.Hc(10))X6(b,"TYPE","xmlhttp"),B7(a.rh,b,!1,a.ov,!1);else{X6(b,"TYPE","html");var c=a.rh;a=!!a.ov;c.vu=3;c.An=W6(b.clone());NZa(c,a)}},N7=function(a,b,c){this.i=1;
this.j=[];this.B=[];this.C=new w7;this.N=a||null;this.W=null!=b?b:null;this.I=c||!1},TZa=function(a,b){this.i=a;
this.map=b;this.context=null},UZa=function(a,b,c,d){g.ef.call(this,"timingevent",a);
this.size=b;this.Ox=d},VZa=function(a){g.ef.call(this,"serverreachability",a)},YZa=function(a){WZa(a);
if(3==a.i){var b=a.ax++,c=a.Hz.clone();g.Il(c,"SID",a.u);g.Il(c,"RID",b);g.Il(c,"TYPE","terminate");O7(a,c);b=new A7(a,a.u,b,void 0);b.vu=2;b.An=W6(c.clone());sYa(new Image,b.An.toString());b.Ut=Date.now();C7(b)}XZa(a)},ZZa=function(a){a.cT(1,0);
a.Hz=K7(a,null,a.hD);P7(a)},WZa=function(a){a.En&&(a.En.abort(),a.En=null);
a.Pe&&(a.Pe.cancel(),a.Pe=null);a.Ul&&(g.C.clearTimeout(a.Ul),a.Ul=null);Q7(a);a.Zg&&(a.Zg.cancel(),a.Zg=null);a.Pn&&(g.C.clearTimeout(a.Pn),a.Pn=null)},$Za=function(a,b){if(0==a.i)throw Error("Invalid operation: sending map when state is closed");
a.j.push(new TZa(a.LU++,b));2!=a.i&&3!=a.i||P7(a)},a_a=function(a){var b=0;
a.Pe&&b++;a.Zg&&b++;return b},P7=function(a){a.Zg||a.Pn||(a.Pn=x7((0,g.Ta)(a.bO,a),0),a.Ns=0)},c_a=function(a,b){if(1==a.i){if(!b){a.ax=Math.floor(1E5*Math.random());
b=a.ax++;var c=new A7(a,"",b,void 0);c.yp=a.zk;var d=R7(a),e=a.Hz.clone();g.Il(e,"RID",b);g.Il(e,"CVER","1");O7(a,e);JZa(c,e,d);a.Zg=c;a.i=2}}else 3==a.i&&(b?b_a(a,b):0==a.j.length||a.Zg||b_a(a))},b_a=function(a,b){if(b)if(6<a.Rp){a.j=a.B.concat(a.j);
a.B.length=0;var c=a.ax-1;b=R7(a)}else c=b.N,b=b.Qq;else c=a.ax++,b=R7(a);var d=a.Hz.clone();g.Il(d,"SID",a.u);g.Il(d,"RID",c);g.Il(d,"AID",a.xt);O7(a,d);c=new A7(a,a.u,c,a.Ns+1);c.yp=a.zk;c.setTimeout(1E4+Math.round(1E4*Math.random()));a.Zg=c;JZa(c,d,b)},O7=function(a,b){a.Pf&&(a=a.Pf.wL())&&g.qf(a,function(c,d){g.Il(b,d,c)})},R7=function(a){var b=Math.min(a.j.length,1E3),c=["count="+b];
...
return c.join("&")},d_a=function(a){a.Pe||a.Ul||(a.J=1,a.Ul=x7((0,g.Ta)(a.aO,a),0),a.xs=0)},S7=function(a){if(a.Pe||a.Ul||3<=a.xs)return!1;
a.J++;a.Ul=x7((0,g.Ta)(a.aO,a),e_a(a,a.xs));a.xs++;return!0},L7=function(a,b,c){a.hC=c;
a.Ak=b.Ml;a.I||ZZa(a)},Q7=function(a){null!=a.Zp&&(g.C.clearTimeout(a.Zp),a.Zp=null)},e_a=function(a,b){var c=5E3+Math.floor(1E4*Math.random());
a.isActive()||(c*=2);return c*b},T7=function(a,b){if(2==b||9==b){var c=null;
a.Pf&&(c=null);var d=(0,g.Ta)(a.ZY,a);c||(c=new g.rl("//www.google.com/images/cleardot.gif"),W6(c));PZa(c.toString(),1E4,d)}else z7(2);f_a(a,b)},f_a=function(a,b){a.i=0;
a.Pf&&a.Pf.KK(b);XZa(a);WZa(a)},XZa=function(a){a.i=0;
...
if(""!=d.i)b&&g.tl(d,b+"."+d.i),g.ul(d,d.u);else{var e=window.location;d=dZa(e.protocol,b?b+"."+e.hostname:e.hostname,+e.port,c)}a.Zv&&g.qf(a.Zv,function(f,h){g.Il(d,h,f)});
g.Il(d,"VER",a.Rp);O7(a,d);return d},g_a=function(){},h_a=function(){this.i=[];
this.j=[]},i_a=function(){},s7=function(){if(!U7){U7=new g.Ii(new i_a);
var a=g.us("client_streamz_web_flush_count",-1);-1!==a&&(U7.B=a)}return U7},j_a=function(a,b){this.action=a;
...
e=void 0===e?!1:e;this.qa=a;this.I=b;this.u=new g.Tq;this.j=new V7(this.AY,this);this.i=null;this.Y=!1;this.C=null;this.W="";this.N=this.B=0;this.J=[];this.ya=c;this.oa=d;this.Ha=e;this.xa=new EZa;this.Ia=new FZa;this.La=new GZa},k_a=function(a){return{firstTestResults:[""],
secondTestResults:!a.i.hC,sessionId:a.i.u,arrayId:a.i.xt}},l_a=function(a,b){a.N=b||0;
a.j.stop();X7(a);a.i&&(3==a.i.getState()&&c_a(a.i),YZa(a.i));a.N=0},Y7=function(a){return!!a.i&&3==a.i.getState()},X7=function(a){if(a.i){var b=a.oa(),c=a.i.zk||{};
...
method:"POST",context:a,timeout:5E3,withCredentials:!1,onSuccess:g.Ua(a.B,d,!0),onError:g.Ua(a.u,e),onTimeout:g.Ua(a.C,e)};c&&(a.postParams=c,a.headers={"Content-Type":"application/x-www-form-urlencoded"});return g.Us(b,a)},p_a=function(){var a=m_a;
n_a();b8.push(a);o_a()},c8=function(a,b){n_a();
var c=q_a(a,String(b));g.cc(b8)?r_a(c):(o_a(),g.yc(b8,function(d){d(c)}))},n_a=function(){b8||(b8=g.La("yt.mdx.remote.debug.handlers_")||[],g.Ka("yt.mdx.remote.debug.handlers_",b8,void 0))},r_a=function(a){var b=(d8+1)%50;
d8=b;e8[b]=a;f8||(f8=49==b)},o_a=function(){var a=b8;
if(e8[0]){var b=f8?d8:-1;do{b=(b+1)%50;var c=e8[b];g.yc(a,function(d){d(c)})}while(b!=d8);
e8=Array(50);d8=-1;f8=!1}},q_a=function(a,b){var c=(Date.now()-s_a)/1E3;
c.toFixed&&(c=c.toFixed(3));var d=[];d.push("[",c+"s","] ");d.push("[","yt.mdx.remote","] ");d.push(a+": "+b,"\n");return d.join("")},g8=function(a){g.Ow.call(this);
this.I=a;this.screens=[]},t_a=function(a,b){var c=a.get(b.uuid)||a.get(b.id);
if(c)return a=c.name,c.id=b.id||c.id,c.name=b.name,c.token=b.token,c.uuid=b.uuid||c.uuid,c.name!=a;a.screens.push(b);return!0},u_a=function(a,b){var c=a.screens.length!=b.length;
a.screens=g.Mo(a.screens,function(f){return!!g7(b,f)});
for(var d=0,e=b.length;d<e;d++)c=t_a(a,b[d])||c;return c},v_a=function(a,b){var c=a.screens.length;
...
this.j=a;this.i=NaN;i8(this);this.info("Initializing with "+e7(this.screens))},w_a=function(a){if(a.screens.length){var b=g.vn(a.screens,function(d){return d.id}),c=$7(a.j,"/pairing/get_lounge_token_batch");
a8(a.j,c,{screen_ids:b.join(",")},(0,g.Ta)(a.BT,a),(0,g.Ta)(a.AT,a))}},i8=function(a){if(g.Q("deprecate_pair_servlet_enabled"))return u_a(a,[]);
var b=jZa(pZa());b=g.Mo(b,function(c){return!c.uuid});
return u_a(a,b)},k8=function(a,b){rZa(g.vn(a.screens,hZa));
b&&qZa()},m8=function(a,b){g.Ow.call(this);
...
else{c=g.yf(b);for(var d=0,e=c.length;d<e;++d)if(!a.i[c[d]]){c=!1;break a}c=!0}c||(l8("Updated online screens: "+g.lj(a.i)),a.i=b,a.Z("screenChange"));x_a(a)},p8=function(a){isNaN(a.u)||g.Qs(a.u);
a.u=g.Os((0,g.Ta)(a.eH,a),0<a.B&&a.B<g.Va()?2E4:1E4)},l8=function(a){c8("OnlineScreenService",a)},y_a=function(a){var b={};
g.yc(a.I(),function(c){c.token?b[c.token]=c.id:this.re("Requesting availability of screen w/o lounge token.")});
return b},x_a=function(a){a=g.yf(g.rf(a.i,function(b){return b}));
...
g8.call(this,"ScreenService");this.B=a;this.J=b;this.i=this.j=null;this.u=[];this.C={};z_a(this)},B_a=function(a,b,c,d,e,f){a.info("getAutomaticScreenByIds "+c+" / "+b);
c||(c=a.C[b]);var h=a.Ih(),l=c?h7(h,c):null;c&&(a.J||l)||(l=h7(h,b));if(l){l.uuid=b;var m=r8(a,l);n8(a.i,m,function(n){e(n?m:null)})}else c?A_a(a,c,(0,g.Ta)(function(n){var p=r8(this,new b7({name:d,
screenId:c,loungeToken:n,dialId:b||""}));n8(this.i,p,function(r){e(r?p:null)})},a),f):e(null)},C_a=function(a,b){for(var c=0,d=a.screens.length;c<d;++c)if(a.screens[c].name==b)return a.screens[c];
return null},D_a=function(a,b,c){n8(a.i,b,c)},A_a=function(a,b,c,d){a.info("requestLoungeToken_ for "+b);
...
g.Us($7(a.B,"/pairing/get_lounge_token_batch"),e)},E_a=function(a){a.screens=a.j.Ih();
var b=a.C,c={},d;for(d in b)c[b[d]]=d;b=0;for(d=a.screens.length;b<d;++b){var e=a.screens[b];e.uuid=c[e.id]||""}a.info("Updated manual screens: "+e7(a.screens))},z_a=function(a){s8(a);
a.j=new j8(a.B);a.j.subscribe("screenChange",(0,g.Ta)(a.KT,a));E_a(a);a.J||(a.u=jZa(g.Ex("yt-remote-automatic-screen-cache")||[]));s8(a);a.info("Initializing automatic screens: "+e7(a.u));a.i=new m8(a.B,(0,g.Ta)(a.Ih,a,!0));a.i.subscribe("screenChange",(0,g.Ta)(function(){this.Z("onlineScreenChange")},a))},r8=function(a,b){var c=a.get(b.id);
c?(c.uuid=b.uuid,b=c):((c=h7(a.u,b.uuid))?(c.id=b.id,c.token=b.token,b=c):a.u.push(b),a.J||F_a(a));s8(a);a.C[b.uuid]=b.id;g.Dx("yt-remote-device-id-map",a.C,31536E3);return b},F_a=function(a){a=g.Mo(a.u,function(b){return"shortLived"!=b.idType});
g.Dx("yt-remote-automatic-screen-cache",g.vn(a,hZa))},s8=function(a){a.C=g.Ex("yt-remote-device-id-map")||{}},t8=function(a,b,c){g.Ow.call(this);
this.ya=c;this.u=a;this.i=b;this.B=null},u8=function(a,b){a.B=b;
a.Z("sessionScreen",a.B)},G_a=function(a,b){a.B&&(a.B.token=b,r8(a.u,a.B));
a.Z("sessionScreen",a.B)},v8=function(a,b){c8(a.ya,b)},w8=function(a,b,c){t8.call(this,a,b,"CastSession");
var d=this;this.config_=c;this.j=null;this.oa=(0,g.Ta)(this.MR,this);this.xa=(0,g.Ta)(this.WX,this);this.Y=g.Os(function(){H_a(d,null)},12E4);
this.J=this.C=this.I=this.N=0;this.qa=!1;this.W="unknown"},x8=function(a,b){g.Qs(a.J);
a.J=0;0==b?I_a(a):a.J=g.Os(function(){I_a(a)},b)},I_a=function(a){J_a(a,"getLoungeToken");
g.Qs(a.C);a.C=g.Os(function(){K_a(a,null)},3E4)},J_a=function(a,b){a.info("sendYoutubeMessage_: "+b+" "+g.lj(void 0));
var c={};c.type=b;a.j?a.j.sendMessage("urn:x-cast:com.google.youtube.mdx",c,function(){},(0,g.Ta)(function(){v8(this,"Failed to send message: "+b+".")},a)):v8(a,"Sending yt message without session: "+g.lj(c))},y8=function(a,b){b?(a.info("onConnectedScreenId_: Received screenId: "+b),a.getScreen()&&a.getScreen().id==b||a.KL(b,function(c){u8(a,c)},function(){return a.Bg()},5)):a.Bg(Error("Waiting for session status timed out."))},M_a=function(a,b,c){a.info("onConnectedScreenData_: Received screenData: "+
JSON.stringify(b));
var d=new b7(b);L_a(a,d,function(e){e?(a.qa=!0,r8(a.u,d),u8(a,d),a.W="unknown",x8(a,c)):(g.ys(Error("CastSession, RemoteScreen from screenData: "+JSON.stringify(b)+" is not online.")),a.Bg())},5)},H_a=function(a,b){g.Qs(a.Y);
a.Y=0;b?a.config_.enableCastLoungeToken&&b.loungeToken?b.deviceId?a.getScreen()&&a.getScreen().uuid==b.deviceId||(b.loungeTokenRefreshIntervalMs?M_a(a,{name:a.i.friendlyName,screenId:b.screenId,loungeToken:b.loungeToken,dialId:b.deviceId,screenIdType:"shortLived"},b.loungeTokenRefreshIntervalMs):(g.ys(Error("No loungeTokenRefreshIntervalMs presents in mdxSessionStatusData: "+JSON.stringify(b)+".")),y8(a,b.screenId))):(g.ys(Error("No device id presents in mdxSessionStatusData: "+JSON.stringify(b)+
".")),y8(a,b.screenId)):y8(a,b.screenId):a.Bg(Error("Waiting for session status timed out."))},K_a=function(a,b){g.Qs(a.C);
a.C=0;var c=null;if(b)if(b.loungeToken){var d;(null==(d=a.getScreen())?void 0:d.token)==b.loungeToken&&(c="staleLoungeToken")}else c="missingLoungeToken";else c="noLoungeTokenResponse";c?(a.info("Did not receive a new lounge token in onLoungeToken_ with data: "+(JSON.stringify(b)+", error: "+c)),a.W=c,x8(a,3E4)):(G_a(a,b.loungeToken),a.qa=!1,a.W="unknown",x8(a,b.loungeTokenRefreshIntervalMs))},L_a=function(a,b,c,d){g.Qs(a.I);
a.I=0;D_a(a.u,b,function(e){e||0>d?c(e):a.I=g.Os(function(){L_a(a,b,c,d-1)},300)})},N_a=function(a){g.Qs(a.N);
...
return!!(a.config_.enableDialLoungeToken&&(null==(b=a.j)?0:b.getDialAppInfo))},O_a=function(a){a.C=a.u.xJ(a.xa,a.i.label,a.i.friendlyName,A8(a),function(b,c){a.C=function(){};
a.oa=!0;u8(a,b);"shortLived"==b.idType&&0<c&&B8(a,c)},function(b){a.C=function(){};
a.Bg(b)})},P_a=function(a){var b={};
b.pairingCode=a.xa;b.theme=a.La;uZa()&&(b.env_useStageMdx=1);return g.Ej(b)},C8=function(a){return new Promise(function(b){a.xa=f7();
if(a.Ia){var c=new chrome.cast.DialLaunchResponse(!0,P_a(a));b(c);O_a(a)}else a.Y=function(){g.Qs(a.W);a.Y=function(){};
a.W=NaN;var d=new chrome.cast.DialLaunchResponse(!0,P_a(a));b(d);O_a(a)},a.W=g.Os(function(){a.Y()},100)})},R_a=function(a,b,c){a.info("initOnConnectedScreenDataPromise_: Received screenData: "+JSON.stringify(b));
var d=new b7(b);return(new Promise(function(e){Q_a(a,d,function(f){f?(a.oa=!0,r8(a.u,d),u8(a,d),B8(a,c)):g.ys(Error("DialSession, RemoteScreen from screenData: "+JSON.stringify(b)+" is not online."));e(f)},5)})).then(function(e){return e?new chrome.cast.DialLaunchResponse(!1):C8(a)})},S_a=function(a,b){var c=a.N.receiver.label,d=a.i.friendlyName;
return(new Promise(function(e){B_a(a.u,c,b,d,function(f){f&&f.token&&u8(a,f);e(f)},function(f){v8(a,"Failed to get DIAL screen: "+f);
e(null)})})).then(function(e){return e&&e.token?new chrome.cast.DialLaunchResponse(!1):C8(a)})},Q_a=function(a,b,c,d){g.Qs(a.I);
a.I=0;D_a(a.u,b,function(e){e||0>d?c(e):a.I=g.Os(function(){Q_a(a,b,c,d-1)},300)})},B8=function(a,b){a.info("getDialAppInfoWithTimeout_ "+b);
A8(a)&&(g.Qs(a.J),a.J=0,0==b?T_a(a):a.J=g.Os(function(){T_a(a)},b))},T_a=function(a){A8(a)&&a.j.getDialAppInfo(function(b){a.info("getDialAppInfo dialLaunchData: "+JSON.stringify(b));
b=b.extraData||{};var c=null;if(b.loungeToken){var d;(null==(d=a.getScreen())?void 0:d.token)==b.loungeToken&&(c="staleLoungeToken")}else c="missingLoungeToken";c?(a.qa=c,B8(a,3E4)):(a.oa=!1,a.qa="unknown",G_a(a,b.loungeToken),B8(a,b.loungeTokenRefreshIntervalMs))},function(b){a.info("getDialAppInfo error: "+b);
a.qa="noLoungeTokenResponse";B8(a,3E4)})},U_a=function(a){g.Qs(a.I);
...
this.config_=b;this.j=a;this.N=b.appId||"233637DE";this.B=b.theme||"cl";this.W=b.disableCastApi||!1;this.I=b.forceMirroring||!1;this.i=null;this.J=!1;this.u=[];this.C=(0,g.Ta)(this.PW,this)},V_a=function(a,b){return b?g.Xb(a.u,function(c){return c7(b,c.label)},a):null},F8=function(a){c8("Controller",a)},m_a=function(a){window.chrome&&chrome.cast&&chrome.cast.logMessage&&chrome.cast.logMessage(a)},G8=function(a){return a.J||!!a.u.length||!!a.i},H8=function(a,b,c){b!=a.i&&(g.bf(a.i),(a.i=b)?(c?a.Z("yt-remote-cast2-receiver-resumed",
b.i):a.Z("yt-remote-cast2-receiver-selected",b.i),b.subscribe("sessionScreen",(0,g.Ta)(a.ZN,a,b)),b.subscribe("sessionFailed",function(){return W_a(a,b)}),b.getScreen()?a.Z("yt-remote-cast2-session-change",b.getScreen()):c&&a.i.zt(null)):a.Z("yt-remote-cast2-session-change",null))},W_a=function(a,b){a.i==b&&a.Z("yt-remote-cast2-session-failed")},X_a=function(a){var b=a.j.wJ(),c=a.i&&a.i.i;
a=g.vn(b,function(d){c&&c7(d,c.label)&&(c=null);var e=d.uuid?d.uuid:d.id,f=V_a(this,d);f?(f.label=e,f.friendlyName=d.name):(f=new chrome.cast.Receiver(e,d.name),f.receiverType=chrome.cast.ReceiverType.CUSTOM);return f},a);
c&&(c.receiverType!=chrome.cast.ReceiverType.CUSTOM&&(c=new chrome.cast.Receiver(c.label,c.friendlyName),c.receiverType=chrome.cast.ReceiverType.CUSTOM),a.push(c));return a},b0a=function(a,b,c,d){d.disableCastApi?I8("Cannot initialize because disabled by Mdx config."):Y_a()?Z_a(b,d)&&(J8(!0),window.chrome&&chrome.cast&&chrome.cast.isAvailable?$_a(a,c):(window.__onGCastApiAvailable=function(e,f){e?$_a(a,c):(K8("Failed to load cast API: "+f),L8(!1),J8(!1),g.Fx("yt-remote-cast-available"),g.Fx("yt-remote-cast-receiver"),
a0a(),c(!1))},d.loadCastApiSetupScript?g.Hx("https://www.gstatic.com/cv/js/sender/v1/cast_sender.js"):0<=window.navigator.userAgent.indexOf("Android")&&0<=window.navigator.userAgent.indexOf("Chrome/")&&window.navigator.presentation?60<=o7()&&BZa():!window.chrome||!window.navigator.presentation||0<=window.navigator.userAgent.indexOf("Edge")?q7():89<=o7()?DZa():(r7(),p7(CZa.map(yZa))))):I8("Cannot initialize because not running Chrome")},a0a=function(){I8("dispose");
var a=M8();a&&a.dispose();g.Ka("yt.mdx.remote.cloudview.instance_",null,void 0);c0a(!1);g.du(N8);N8.length=0},O8=function(){return!!g.Ex("yt-remote-cast-installed")},d0a=function(){var a=g.Ex("yt-remote-cast-receiver");
return a?a.friendlyName:null},e0a=function(){I8("clearCurrentReceiver");
g.Fx("yt-remote-cast-receiver")},f0a=function(){return O8()?M8()?M8().getCastSession():(K8("getCastSelector: Cast is not initialized."),null):(K8("getCastSelector: Cast API is not installed!"),null)},Q8=function(){O8()?M8()?P8()?(I8("Requesting cast selector."),M8().requestSession()):(I8("Wait for cast API to be ready to request the session."),N8.push(g.cu("yt-remote-cast2-api-ready",Q8))):K8("requestCastSelector: Cast is not initialized."):K8("requestCastSelector: Cast API is not installed!")},R8=
function(a,b){P8()?M8().setConnectedScreenStatus(a,b):K8("setConnectedScreenStatus called before ready.")},Y_a=function(){var a=0<=g.zb().search(/ (CrMo|Chrome|CriOS)\//);
return g.oz||a},g0a=function(a,b){M8().init(a,b)},Z_a=function(a,b){var c=!1;
...
I8("cloudview.createSingleton_: "+c);return c},M8=function(){return g.La("yt.mdx.remote.cloudview.instance_")},$_a=function(a,b){L8(!0);
J8(!1);g0a(a,function(c){c?(c0a(!0),g.eu("yt-remote-cast2-api-ready")):(K8("Failed to initialize cast API."),L8(!1),g.Fx("yt-remote-cast-available"),g.Fx("yt-remote-cast-receiver"),a0a());b(c)})},I8=function(a){c8("cloudview",a)},K8=function(a){c8("cloudview",a)},L8=function(a){I8("setCastInstalled_ "+a);
g.Dx("yt-remote-cast-installed",a)},P8=function(){return!!g.La("yt.mdx.remote.cloudview.apiReady_")},c0a=function(a){I8("setApiReady_ "+a);
...
this.u=0;this.B=a;this.I=[];this.C=new h_a;this.j=this.i=null;this.W=(0,g.Ta)(this.vV,this);this.J=(0,g.Ta)(this.mx,this);this.N=(0,g.Ta)(this.uV,this);this.Y=(0,g.Ta)(this.CV,this);var c=0;a?(c=a.getProxyState(),3!=c&&(a.subscribe("proxyStateChange",this.vH,this),h0a(this))):c=3;0!=c&&(b?this.vH(c):g.Os((0,g.Ta)(function(){this.vH(c)},this),0));
(a=f0a())&&Z8(this,a);this.subscribe("yt-remote-cast2-session-change",this.Y)},a9=function(a){return new S8(a.B.getPlayerContextData())},h0a=function(a){g.yc("nowAutoplaying autoplayDismissed remotePlayerChange remoteQueueChange autoplayModeChange autoplayUpNext previousNextChange multiStateLoopEnabled loopModeChange".split(" "),function(b){this.I.push(this.B.subscribe(b,g.Ua(this.NW,b),this))},a)},i0a=function(a){g.yc(a.I,function(b){this.B.unsubscribeByKey(b)},a);
...
V8(d,c);-1E3!=d.playerState&&(d.playerState=b);d9(a,d)},f9=function(a,b,c){a.B.sendMessage(b,c)},d9=function(a,b){i0a(a);
a.B.setPlayerContextData(Y8(b));h0a(a)},Z8=function(a,b){a.j&&(a.j.removeUpdateListener(a.W),a.j.removeMediaListener(a.J),a.mx(null));
a.j=b;a.j&&(c8("CP","Setting cast session: "+a.j.sessionId),a.j.addUpdateListener(a.W),a.j.addMediaListener(a.J),a.j.media.length&&a.mx(a.j.media[0]))},j0a=function(a){var b=a.i.media,c=a.i.customData;
...
this.j=[];this.wc=new S8;this.Ia=b.id;this.xa=b.idType;this.i=k0a(this,c);this.i.subscribe("handlerOpened",this.zV,this);this.i.subscribe("handlerClosed",this.wV,this);this.i.subscribe("handlerError",this.xV,this);this.i.subscribe("handlerMessage",this.yV,this);this.i.IB(b.token);this.subscribe("remoteQueueChange",function(){var f=this.wc.videoId;g.Gx()&&g.Dx("yt-remote-session-video-id",f)},this)},l0a=function(a){return g.Xb(a.j,function(b){return"LOUNGE_SCREEN"==b.type})},i9=function(a){c8("conn",
a)},k0a=function(a,b){return new W7($7(a.Ha,"/bc"),b,!1,function(){return a.BJ()},"shortLived"==a.xa)},j9=function(a,b){a.Z("proxyStateChange",b)},m0a=function(a){a.C=g.Os(function(){i9("Connecting timeout");
a.Js(1)},2E4)},k9=function(a){g.Qs(a.C);
a.C=NaN},l9=function(a){g.Qs(a.oa);
a.oa=NaN},n0a=function(a){m9(a);
a.Y=g.Os(function(){n9(a,"getNowPlaying")},2E4)},m9=function(a){g.Qs(a.Y);
a.Y=NaN},p0a=function(a,b){var c=null;
if(b){var d=l0a(a);d&&(c={clientName:d.clientName,deviceMake:d.brand,deviceModel:d.model,osVersion:d.osVersion})}g.Ka("yt.mdx.remote.remoteClient_",c,void 0);b&&(k9(a),l9(a));c=Y7(a.i)&&isNaN(a.C);b==c?b&&(j9(a,1),n9(a,"getSubtitlesTrack")):b?(a.JL()&&a.wc.reset(),j9(a,1),n9(a,"getNowPlaying"),o0a(a)):a.Js(1)},q0a=function(a,b){var c=b.params.videoId;
delete b.params.videoId;c==a.wc.videoId&&(g.Df(b.params)?a.wc.trackData=null:a.wc.trackData=b.params,a.Z("remotePlayerChange"))},r0a=function(a,b,c){var d=b.params.videoId||b.params.video_id,e=parseInt(b.params.currentIndex,10);
a.wc.listId=b.params.listId||a.wc.listId;X8(a.wc,d,e);a.Z("remoteQueueChange",c)},t0a=function(a,b){b.params=b.params||{};
r0a(a,b,"NOW_PLAYING_MAY_CHANGE");s0a(a,b);a.Z("autoplayDismissed")},s0a=function(a,b){var c=parseInt(b.params.currentTime||b.params.current_time,10);
V8(a.wc,isNaN(c)?0:c);c=parseInt(b.params.state,10);c=isNaN(c)?-1:c;-1==c&&-1E3==a.wc.playerState&&(c=-1E3);a.wc.playerState=c;c=Number(b.params.loadedTime);a.wc.N=isNaN(c)?0:c;a.wc.Yj(Number(b.params.duration));c=a.wc;var d=Number(b.params.liveIngestionTime);c.u=d;c.j=isNaN(d)?!1:!0;c=a.wc;d=Number(b.params.seekableStartTime);b=Number(b.params.seekableEndTime);c.B=isNaN(d)?0:d;c.i=isNaN(b)?0:b;1==a.wc.playerState?n0a(a):m9(a);a.Z("remotePlayerChange")},u0a=function(a,b){if(-1E3!=a.wc.playerState){var c=
1085;
switch(parseInt(b.params.adState,10)){case 1:c=1081;break;case 2:c=1084;break;case 0:c=1083}a.wc.playerState=c;b=parseInt(b.params.currentTime,10);V8(a.wc,isNaN(b)?0:b);a.Z("remotePlayerChange")}},v0a=function(a,b){var c="true"==b.params.muted;
a.wc.volume=parseInt(b.params.volume,10);a.wc.muted=c;a.Z("remotePlayerChange")},w0a=function(a,b){a.I=b.params.videoId;
a.Z("nowAutoplaying",parseInt(b.params.timeout,10))},x0a=function(a,b){var c="true"==b.params.hasNext;
a.wc.bl="true"==b.params.hasPrevious;a.wc.hasNext=c;a.Z("previousNextChange")},o0a=function(a){g.Qs(a.N);
...
this.We=a;this.i=[];this.i.push(this.We.$_s("screenChange",(0,g.Ta)(this.RR,this)));this.i.push(this.We.$_s("onlineScreenChange",(0,g.Ta)(this.tW,this)))},B0a=function(a,b){tZa();
if(!n7||!n7.get("yt-remote-disable-remote-module-for-dev")){b=g.P("MDX_CONFIG")||b;lZa();l7();p9||(p9=new Z7(b?b.loungeApiHost:void 0),uZa()&&(p9.i="/api/loungedev"));q9||(q9=g.La("yt.mdx.remote.deferredProxies_")||[],g.Ka("yt.mdx.remote.deferredProxies_",q9,void 0));y0a();var c=r9();if(!c){var d=new q8(p9,b?b.disableAutomaticScreenCache||!1:!1);g.Ka("yt.mdx.remote.screenService_",d,void 0);c=r9();var e={};b&&(e={appId:b.appId,disableDial:b.disableDial,theme:b.theme,loadCastApiSetupScript:b.loadCastApiSetupScript,
disableCastApi:b.disableCastApi,enableDialLoungeToken:b.enableDialLoungeToken,enableCastLoungeToken:b.enableCastLoungeToken,forceMirroring:b.forceMirroring});g.Ka("yt.mdx.remote.enableConnectWithInitialState_",b?b.enableConnectWithInitialState||!1:!1,void 0);b0a(a,d,function(f){f?s9()&&R8(s9(),"YouTube TV"):d.subscribe("onlineScreenChange",function(){$6("yt-remote-receiver-availability-change")})},e)}b&&!g.La("yt.mdx.remote.initialized_")&&(g.Ka("yt.mdx.remote.initialized_",!0,void 0),t9("Initializing: "+
...
$6("yt-remote-auto-connect","cast-selector-receiver")})),u9.push(g.cu("yt-remote-cast2-receiver-resumed",function(){$6("yt-remote-receiver-resumed","cast-selector-receiver")})),u9.push(g.cu("yt-remote-cast2-session-change",z0a)),u9.push(g.cu("yt-remote-connection-change",function(f){f?R8(s9(),"YouTube TV"):w9()||(R8(null,null),e0a())})),u9.push(g.cu("yt-remote-cast2-session-failed",function(){$6("yt-remote-connection-failed")})),a=x9(),b.isAuto&&(a.id+="#dial"),e=b.capabilities||[],g.Q("desktop_enable_autoplay")&&
e.push("atp"),0<e.length&&(a.capabilities=e),a.name=b.device,a.app=b.app,(b=b.theme)&&(a.theme=b),t9(" -- with channel params: "+g.lj(a)),a?(g.Dx("yt-remote-session-app",a.app),g.Dx("yt-remote-session-name",a.name)):(g.Fx("yt-remote-session-app"),g.Fx("yt-remote-session-name")),g.Ka("yt.mdx.remote.channelParams_",a,void 0),c.start(),s9()||A0a())}},C0a=function(){var a=r9().We.$_gos();
var b=y9();b&&z9()&&(g7(a,b)||a.push(b));return kZa(a)},A9=function(){var a=D0a();
!a&&O8()&&d0a()&&(a={key:"cast-selector-receiver",name:d0a()});return a},D0a=function(){var a=C0a(),b=y9();
b||(b=w9());return g.Xb(a,function(c){return b&&c7(b,c.key)?!0:!1})},y9=function(){var a=s9();
if(!a)return null;var b=r9().Ih();return h7(b,a)},z0a=function(a){t9("remote.onCastSessionChange_: "+d7(a));
...
G9=a?new o9(a):null}return G9},s9=function(){return g.La("yt.mdx.remote.currentScreenId_")},E0a=function(a){g.Ka("yt.mdx.remote.currentScreenId_",a,void 0)},F0a=function(){return g.La("yt.mdx.remote.connectData_")},v9=function(a){g.Ka("yt.mdx.remote.connectData_",a,void 0)},z9=function(){return g.La("yt.mdx.remote.connection_")},E9=function(a){var b=z9();
v9(null);a||E0a("");g.Ka("yt.mdx.remote.connection_",a,void 0);q9&&(g.yc(q9,function(c){c(a)}),q9.length=0);
...
y9()&&y9();if(H9)B9=a;else{E0a(a.id);var c=g.La("yt.mdx.remote.enableConnectWithInitialState_")||!1;a=new h9(p9,a,x9(),c);a.connect(b,F0a());a.subscribe("beforeDisconnect",function(d){$6("yt-remote-before-disconnect",d)});
...
E9(a)}},A0a=function(){var a=w9();
a?(t9("Resume connection to: "+d7(a)),D9(a,0)):(m7(),e0a(),t9("Skipping connecting because no session screen found."))},y0a=function(){var a=x9();
...
var d=this;this.j=a;this.G=b;this.Vb=c;this.events=new g.hC(this);this.Y=this.events.S(this.G,"onVolumeChange",function(e){G0a(d,e)});
...
a=this.Vb;a.isDisposed();a.subscribe("proxyStateChange",this.VN,this);a.subscribe("remotePlayerChange",this.sx,this);a.subscribe("remoteQueueChange",this.bB,this);a.subscribe("previousNextChange",this.SN,this);a.subscribe("nowAutoplaying",this.MN,this);a.subscribe("autoplayDismissed",this.pN,this);g.J(this,this.i);g.J(this,this.u);g.J(this,this.N);g.J(this,this.W);g.J(this,this.J);this.lP();this.bB();this.sx()},G0a=function(a,b){if(J9(a)){a.Vb.unsubscribe("remotePlayerChange",a.sx,a);
var c=Math.round(b.volume);b=!!b.muted;var d=a9(a.Vb);if(c!==d.volume||b!==d.muted)a.Vb.setVolume(c,b),a.W.start();a.Vb.subscribe("remotePlayerChange",a.sx,a)}},H0a=function(a){a.Rb(0);
...
if(null===c||void 0===c?0:c.listId){var d=c.index;var e=c.listId.toString()}c=a.G.getVideoData(1);a.Vb.playVideo(c.videoId,b,d,e,c.playerParams,c.Ya,aZa(c));a.Wb(new g.JI(1))},I0a=function(a,b){if(b){var c=a.G.getOption("captions","tracklist",{gM:1});
...
K:"ytp-mdx-popup-dialog",V:{role:"dialog"},U:[{D:"div",K:"ytp-mdx-popup-dialog-inner-content",U:[{D:"div",K:"ytp-mdx-popup-title",ma:"You're signed out"},{D:"div",K:"ytp-mdx-popup-description",ma:"Videos you watch may be added to the TV's watch history and influence TV recommendations. To avoid this, cancel and sign in to YouTube on your computer."},{D:"div",K:"ytp-mdx-privacy-popup-buttons",U:[{D:"button",Ga:["ytp-button","ytp-mdx-privacy-popup-cancel"],ma:"Cancel"},{D:"button",Ga:["ytp-button",
"ytp-mdx-privacy-popup-confirm"],ma:"Confirm"}]}]}]});this.i=new g.JK(this,250);this.cancelButton=this.Da("ytp-mdx-privacy-popup-cancel");this.confirmButton=this.Da("ytp-mdx-privacy-popup-confirm");g.J(this,this.i);this.S(this.cancelButton,"click",this.j);this.S(this.confirmButton,"click",this.u)},N9=function(a){g.W.call(this,{D:"div",
K:"ytp-remote",U:[{D:"div",K:"ytp-remote-display-status",U:[{D:"div",K:"ytp-remote-display-status-icon",U:[g.ZJ()]},{D:"div",K:"ytp-remote-display-status-text",ma:"{{statustext}}"}]}]});this.api=a;this.i=new g.JK(this,250);g.J(this,this.i);this.S(a,"presentingplayerstatechange",this.onStateChange);J0a(this,a.yb())},J0a=function(a,b){if(3===a.api.getPresentingPlayerType()){var c={RECEIVER_NAME:a.api.getOption("remote","currentReceiver").name};
b=g.V(b,128)?g.dH("Error on $RECEIVER_NAME",c):b.Gc()||g.V(b,4)?g.dH("Playing on $RECEIVER_NAME",c):g.dH("Connected to $RECEIVER_NAME",c);a.Ma("statustext",b);a.i.show()}else a.i.hide()},O9=function(a,b){g.pP.call(this,"Play on",0,a,b);
...
this.ql={key:f7(),name:"This computer"};this.ji=null;this.subscriptions=[];this.QG=this.Vb=null;this.Uo=[this.ql];this.Gn=this.ql;this.Ed=new g.JI(64);this.EM=0;this.Bf=-1;this.Bx=!1;this.zx=this.Pt=null;if(!g.WD(this.player.T())&&!g.XD(this.player.T())){a=this.player;var b=g.RL(a);b&&(b=b.Yn())&&(b=new O9(a,b),g.J(this,b));b=new N9(a);g.J(this,b);g.aM(a,b.element,4);this.Pt=new M9;g.J(this,this.Pt);g.aM(a,this.Pt.element,4);this.Bx=!!w9()}},Q9=function(a){a.zx&&(a.player.removeEventListener("presentingplayerstatechange",
a.zx),a.zx=null)},K0a=function(a,b,c){a.Ed=c;
a.player.Z("presentingplayerstatechange",new g.MG(c,b))},R9=function(a,b){if(b.key!==a.Gn.key)if(b.key===a.ql.key)C9();
else{var c;(c=!a.player.T().L("mdx_enable_privacy_disclosure_ui"))||(c=((c=g.P("PLAYER_CONFIG"))&&c.args&&void 0!==c.args.authuser?!0:!(!g.P("SESSION_INDEX")&&!g.P("LOGGED_IN")))||a.Bx||!a.Pt);(c?0:g.lE(a.player.T())||g.oE(a.player.T()))&&L0a(a);a.Gn=b;if(!a.player.T().L("disable_mdx_connection_in_mdx_module_for_music_web")||!g.XD(a.player.T())){var d=a.player.getPlaylistId();c=a.player.getVideoData(1);var e=c.videoId;if(!d&&!e||(2===a.player.getAppState()||1===a.player.getAppState())&&a.player.T().L("should_clear_video_data_on_player_cued_unstarted"))a=
null;else{var f=a.player.getPlaylist();if(f){var h=[];for(var l=0;l<f.length;l++)h[l]=g.iM(f,l).videoId}else h=[e];f=a.player.getCurrentTime(1);a={videoIds:h,listId:d,videoId:e,playerParams:c.playerParams,clickTrackingParams:c.Ya,index:Math.max(a.player.getPlaylistIndex(),0),currentTime:0===f?void 0:f};(c=aZa(c))&&(a.locationInfo=c)}t9("Connecting to: "+g.lj(b));"cast-selector-receiver"==b.key?(v9(a||null),b=a||null,P8()?M8().setLaunchParams(b):K8("setLaunchParams called before ready.")):!a&&F9()&&
s9()==b.key?$6("yt-remote-connection-change",!0):(C9(),v9(a||null),a=r9().Ih(),(b=h7(a,b.key))&&D9(b,1))}}},L0a=function(a){a.player.yb().Gc()?a.player.pauseVideo():(a.zx=function(b){!a.Bx&&g.OG(b,8)&&(a.player.pauseVideo(),Q9(a))},a.player.addEventListener("presentingplayerstatechange",a.zx));
a.Pt&&a.Pt.hd();z9()||(H9=!0)};
g.$c.prototype.C=g.da(0,function(){var a=g.dd(this);return 4294967296*g.dd(this)+(a>>>0)});
var wYa=g.Ge(function(a,b,c){if(1!==a.j)return!1;g.D(b,c,g.ld(a));return!0},g.Je),OYa=g.Ge(function(a,b,c,d){if(1!==a.j)return!1;
g.Rd(b,c,d,g.ld(a));return!0},g.Je),xYa=g.Ge(function(a,b,c){if(0!==a.j)return!1;
g.D(b,c,g.bd(a.i));return!0},g.Ke),NYa=g.Ge(function(a,b,c,d){if(0!==a.j)return!1;
g.Rd(b,c,d,g.bd(a.i));return!0},g.Ke),FYa=g.Ge(function(a,b,c){if(0!==a.j)return!1;
g.D(b,c,g.cd(a.i));return!0},g.Le),KYa=g.Ge(function(a,b,c,d){if(0!==a.j)return!1;
g.Rd(b,c,d,g.cd(a.i));return!0},g.Le),SYa=g.Ge(function(a,b,c){if(1!==a.j)return!1;
g.D(b,c,a.i.C());return!0},function(a,b,c){pYa(a,c,g.Jd(b,c))}),UYa=g.Ge(function(a,b,c){if(1!==a.j&&2!==a.j)return!1;
...
if(null!=b)for(var d=0;d<b.length;d++)pYa(a,c,b[d])}),CYa=g.Ge(function(a,b,c){if(0!==a.j)return!1;
g.D(b,c,g.ed(a.i));return!0},qYa),LYa=g.Ge(function(a,b,c,d){if(0!==a.j)return!1;
g.Rd(b,c,d,g.ed(a.i));return!0},qYa),TYa=g.Ge(function(a,b,c){if(2!==a.j)return!1;
a=g.nd(a);g.Id(b);g.Ld(b,c).push(a);return!0},function(a,b,c){b=g.Ld(b,c);
if(null!=b)for(var d=0;d<b.length;d++){var e=b[d];null!=e&&g.yd(a,c,g.ib(e))}}),JYa=g.Ge(function(a,b,c,d){if(2!==a.j)return!1;
g.Rd(b,c,d,g.nd(a));return!0},g.Me),QYa=g.Ge(function(a,b,c,d,e){if(2!==a.j)return!1;
g.kd(a,g.Sd(b,d,c),e);return!0},g.Ne),tYa=[1];
g.w(uYa,g.F);g.w(vYa,g.F);g.w(AYa,g.F);g.w(BYa,g.F);var HYa=[1,2];g.w(EYa,g.F);var MZa={"\x00":"\\0","\b":"\\b","\f":"\\f","\n":"\\n","\r":"\\r","\t":"\\t","\v":"\\x0B",'"':'\\"',"\\":"\\\\","<":"\\u003C"},G7={"'":"\\'"},gZa={O_:"atp",nca:"ska",Raa:"que",E9:"mus",mca:"sus",q5:"dsp",rba:"seq",h9:"mic",m4:"dpa",f0:"cds",C9:"mlm",i4:"dsdtr",k$:"ntb"};a7.prototype.equals=function(a){return a?this.id==a.id:!1};
var n7,j7="",AZa=vZa("loadCastFramework")||vZa("loadCastApplicationFramework"),CZa=["pkedcjkdefgpdelpbcmbmeomcjbeemfm","enhhojjnijigcajfphajepfemndkmdlo"];/*
...
g.k.SX=function(){this.Iu=null;var a=Date.now();0<=a-this.nI?(2!=this.vu&&this.i.Oj(3),E7(this),this.pn=2,z7(18),F7(this)):OZa(this,this.nI-a)};
g.k.getLastError=function(){return this.pn};g.k=RZa.prototype;g.k.fD=null;g.k.rh=null;g.k.xB=!1;g.k.hP=null;g.k.Gz=null;g.k.LF=null;g.k.gD=null;g.k.ai=null;g.k.Ml=-1;g.k.ov=null;g.k.Fv=null;g.k.connect=function(a){this.gD=a;a=K7(this.i,null,this.gD);z7(3);this.hP=Date.now();var b=this.i.N;null!=b?(this.ov=b[0],(this.Fv=b[1])?(this.ai=1,SZa(this)):(this.ai=2,M7(this))):(X6(a,"MODE","init"),this.rh=new A7(this,void 0,void 0,void 0),this.rh.yp=this.fD,B7(this.rh,a,!1,null,!0),this.ai=0)};
...
g.k.Qy=function(){this.Ml=this.rh.hv;if(this.rh.Ym)0==this.ai?this.Fv?(this.ai=1,SZa(this)):(this.ai=2,M7(this)):2==this.ai&&((!g.Oc||g.Hc(10)?!this.xB:200>this.LF-this.Gz)?(z7(11),L7(this.i,this,!1)):(z7(12),L7(this.i,this,!0)));else{0==this.ai?z7(9):2==this.ai&&z7(10);var a=this.i;this.rh.getLastError();a.Ak=this.Ml;T7(a,2)}};
g.k.Yx=function(){return this.i.Yx()};
g.k.isActive=function(){return this.i.isActive()};
g.k.Oj=function(a){this.i.Oj(a)};g.k=N7.prototype;g.k.zk=null;g.k.Zv=null;g.k.Zg=null;g.k.Pe=null;g.k.hD=null;g.k.Hz=null;g.k.uK=null;g.k.Ry=null;g.k.ax=0;g.k.LU=0;g.k.Pf=null;g.k.Pn=null;g.k.Ul=null;g.k.Zp=null;g.k.En=null;g.k.hC=null;g.k.xt=-1;g.k.DM=-1;g.k.Ak=-1;g.k.Ns=0;g.k.xs=0;g.k.Rp=8;g.Wa(UZa,g.ef);g.Wa(VZa,g.ef);g.k=N7.prototype;g.k.connect=function(a,b,c,d,e){z7(0);this.hD=b;this.Zv=c||{};d&&void 0!==e&&(this.Zv.OSID=d,this.Zv.OAID=e);this.I?(x7((0,g.Ta)(this.QK,this,a),100),ZZa(this)):this.QK(a)};
g.k.QK=function(a){this.En=new RZa(this);this.En.fD=this.zk;this.En.j=this.C;this.En.connect(a)};
g.k.yf=function(){return 0==this.i};
g.k.getState=function(){return this.i};
g.k.bO=function(a){this.Pn=null;c_a(this,a)};
g.k.aO=function(){this.Ul=null;this.Pe=new A7(this,this.u,"rpc",this.J);this.Pe.yp=this.zk;this.Pe.eD=0;var a=this.uK.clone();g.Il(a,"RID","rpc");g.Il(a,"SID",this.u);g.Il(a,"CI",this.hC?"0":"1");g.Il(a,"AID",this.xt);O7(this,a);if(!g.Oc||g.Hc(10))g.Il(a,"TYPE","xmlhttp"),B7(this.Pe,a,!0,this.Ry,!1);else{g.Il(a,"TYPE","html");var b=this.Pe,c=!!this.Ry;b.vu=3;b.An=W6(a.clone());NZa(b,c)}};
...
a&&Q7(this),!g.nb(b))for(a=this.C.parse(b),b=0;b<a.length;b++)c=a[b],this.xt=c[0],c=c[1],2==this.i?"c"==c[0]?(this.u=c[1],this.Ry=c[2],c=c[3],null!=c?this.Rp=c:this.Rp=6,this.i=3,this.Pf&&this.Pf.MK(),this.uK=K7(this,this.Yx()?this.Ry:null,this.hD),d_a(this)):"stop"==c[0]&&T7(this,7):3==this.i&&("stop"==c[0]?T7(this,7):"noop"!=c[0]&&this.Pf&&this.Pf.LK(c),this.xs=0)};
g.k.pV=function(){null!=this.Zp&&(this.Zp=null,this.Pe.cancel(),this.Pe=null,S7(this),z7(20))};
g.k.Qy=function(a){if(this.Pe==a){Q7(this);this.Pe=null;var b=2}else if(this.Zg==a)this.Zg=null,b=1;else return;this.Ak=a.hv;if(0!=this.i)if(a.Ym)if(1==b){b=Date.now()-a.Ut;var c=y7;c.dispatchEvent(new UZa(c,a.Qq?a.Qq.length:0,b,this.Ns));P7(this);this.B.length=0}else d_a(this);else{c=a.getLastError();var d;if(!(d=3==c||7==c||0==c&&0<this.Ak)){if(d=1==b)this.Zg||this.Pn||1==this.i||2<=this.Ns?d=!1:(this.Pn=x7((0,g.Ta)(this.bO,this,a),e_a(this,this.Ns)),this.Ns++,d=!0);d=!(d||2==b&&S7(this))}if(d)switch(c){case 1:T7(this,
...
g.k.ZY=function(a){a?z7(2):(z7(1),f_a(this,8))};
...
g.k.Oj=function(a){var b=y7;b.dispatchEvent(new VZa(b,a))};
g.k.Yx=function(){return!(!g.Oc||g.Hc(10))};
g.k=g_a.prototype;g.k.MK=function(){};
g.k.LK=function(){};
g.k.KK=function(){};
g.k.ZD=function(){};
g.k.wL=function(){return{}};
g.k.isActive=function(){return!0};g.k=h_a.prototype;g.k.isEmpty=function(){return 0===this.i.length&&0===this.j.length};
...
g.k.Di=function(){for(var a=[],b=this.i.length-1;0<=b;--b)a.push(this.i[b]);var c=this.j.length;for(b=0;b<c;++b)a.push(this.j[b]);return a};i_a.prototype.flush=function(a,b){a=void 0===a?[]:a;b=void 0===b?!1:b;if(g.Q("enable_client_streamz_web")){a=g.q(a);for(var c=a.next();!c.done;c=a.next())c=g.Xi(c.value),c={serializedIncrementBatch:g.Kc(g.Fe(c,VYa))},g.Zu("streamzIncremented",c,{pH:b})}};var U7;g.Wa(V7,g.H);g.k=V7.prototype;g.k.BX=function(){this.Yf=Math.min(3E5,2*this.Yf);this.u();this.j&&this.start()};
g.k.start=function(){var a=this.Yf+15E3*Math.random();g.iq(this.i,a);this.j=Date.now()+a};
g.k.stop=function(){this.i.stop();this.j=0};
g.k.isActive=function(){return this.i.isActive()};
g.k.reset=function(){this.i.stop();this.Yf=5E3};g.Wa(W7,g_a);g.k=W7.prototype;g.k.subscribe=function(a,b,c){return this.u.subscribe(a,b,c)};
...
g.k.dispose=function(){this.Y||(this.Y=!0,g.bf(this.u),l_a(this),g.bf(this.j),this.j=null,this.oa=function(){return""})};
g.k.isDisposed=function(){return this.Y};
g.k.connect=function(a,b,c){if(!this.i||2!=this.i.getState()){this.W="";this.j.stop();this.C=a||null;this.B=b||0;a=this.qa+"/test";b=this.qa+"/bind";var d=new N7(c?c.firstTestResults:null,c?c.secondTestResults:null,this.ya),e=this.i;e&&(e.Pf=null);d.Pf=this;this.i=d;X7(this);if(this.i){d=g.P("ID_TOKEN");var f=this.i.zk||{};d?f["x-youtube-identity-token"]=d:delete f["x-youtube-identity-token"];this.i.zk=f}e?(3!=e.getState()&&0==a_a(e)||e.getState(),this.i.connect(a,b,this.I,e.u,e.xt)):c?this.i.connect(a,
b,this.I,c.sessionId,c.arrayId):this.i.connect(a,b,this.I)}};
g.k.sendMessage=function(a,b){a={_sc:a};b&&g.Mf(a,b);this.j.isActive()||2==(this.i?this.i.getState():0)?this.J.push(a):Y7(this)&&(X7(this),$Za(this.i,a))};
g.k.MK=function(){this.j.reset();this.C=null;this.B=0;if(this.J.length){var a=this.J;this.J=[];for(var b=0,c=a.length;b<c;++b)$Za(this.i,a[b])}this.Z("handlerOpened")};
...
g.k.LK=function(a){"S"==a[0]?this.W=a[1]:"gracefulReconnect"==a[0]?(this.j.start(),YZa(this.i)):this.Z("handlerMessage",new j_a(a[0],a[1]))};
...
g.k.AY=function(){this.j.isActive();0==a_a(this.i)&&this.connect(this.C,this.B)};Z7.prototype.B=function(a,b,c,d){b?a(d):a({text:c.responseText})};
Z7.prototype.u=function(a,b){a(Error("Request error: "+b.status))};
Z7.prototype.C=function(a){a(Error("request timed out"))};var s_a=Date.now(),b8=null,e8=Array(50),d8=-1,f8=!1;g.Wa(g8,g.Ow);g8.prototype.Ih=function(){return this.screens};
...
g.k.IR=function(a){this.i=null;a.status&&404==a.status?this.j>=M0a.length?this.Z("pairingFailed",Error("DIAL polling timed out")):(a=M0a[this.j],this.Ob=g.Os((0,g.Ta)(this.oO,this),a),this.j++):this.Z("pairingFailed",Error("Server error "+a.status))};
g.k.KR=function(){this.i=null;this.Z("pairingFailed",Error("Server not responding"))};
var M0a=[2E3,2E3,1E3,1E3,1E3,2E3,2E3,5E3,5E3,1E4];g.Wa(j8,g8);g.k=j8.prototype;g.k.start=function(){i8(this)&&this.Z("screenChange");!g.Ex("yt-remote-lounge-token-expiration")&&w_a(this);g.Qs(this.i);this.i=g.Os((0,g.Ta)(this.start,this),1E4)};
g.k.add=function(a,b){i8(this);t_a(this,a);k8(this,!1);this.Z("screenChange");b(a);a.token||w_a(this)};
g.k.remove=function(a,b){var c=i8(this);v_a(this,a)&&(k8(this,!1),c=!0);b(a);c&&this.Z("screenChange")};
...
g.k.eH=function(){g.Qs(this.u);this.u=NaN;this.j&&this.j.abort();var a=y_a(this);if(Y6(a)){var b=$7(this.C,"/pairing/get_screen_availability");this.j=a8(this.C,b,{lounge_token:g.yf(a).join(",")},(0,g.Ta)(this.hX,this,a),(0,g.Ta)(this.gX,this))}else o8(this,{}),p8(this)};
g.k.hX=function(a,b){this.j=null;var c=g.yf(y_a(this));if(g.vc(c,g.yf(a))){b=b.screens||[];c={};for(var d=0,e=b.length;d<e;++d)c[a[b[d].loungeToken]]="online"==b[d].status;o8(this,c);p8(this)}else this.re("Changing Screen set during request."),this.eH()};
...
g.k.LR=function(a,b,c,d){g.Us($7(this.B,"/pairing/get_screen"),{method:"POST",postParams:{pairing_code:a},timeout:5E3,onSuccess:(0,g.Ta)(function(e,f){e=new b7(f.screen||{});if(!e.name||C_a(this,e.name)){a:{f=e.name;for(var h=2,l=b(f,h);C_a(this,l);){h++;if(20<h)break a;l=b(f,h)}f=l}e.name=f}c(r8(this,e))},this),
...
g.k.KT=function(){E_a(this);this.Z("screenChange");this.i.update()};
...
g.k.uH=function(){};
g.k.va=function(){this.info("disposeInternal");N_a(this);this.j&&(this.j.removeUpdateListener(this.oa),this.j.removeMessageListener("urn:x-cast:com.google.youtube.mdx",this.xa));this.j=null;t8.prototype.va.call(this)};
g.k.WX=function(a,b){if(!this.isDisposed())if(b)if(b=Z6(b),g.Qa(b))switch(a=""+b.type,b=b.data||{},this.info("onYoutubeMessage_: "+a+" "+g.lj(b)),a){case "mdxSessionStatus":H_a(this,b);break;case "loungeToken":K_a(this,b);break;default:v8(this,"Unknown youtube message: "+a)}else v8(this,"Unable to parse message.");else v8(this,"No data in message.")};
g.k.KL=function(a,b,c,d){g.Qs(this.N);this.N=0;B_a(this.u,this.i.label,a,this.i.friendlyName,(0,g.Ta)(function(e){e?b(e):0<=d?(v8(this,"Screen "+a+" appears to be offline. "+d+" retries left."),this.N=g.Os((0,g.Ta)(this.KL,this,a,b,c,d-1),300)):c(Error("Unable to fetch screen."))},this),c)};
...
g.k.stop=function(){U_a(this);this.j?this.j.stop((0,g.Ta)(this.Bg,this,null),(0,g.Ta)(this.Bg,this,"Failed to stop DIAL device.")):this.Bg()};
g.k.va=function(){U_a(this);this.j&&this.j.removeUpdateListener(this.Ha);this.j=null;t8.prototype.va.call(this)};
...
g.k.va=function(){this.j.unsubscribe("onlineScreenChange",(0,g.Ta)(this.zJ,this));window.chrome&&chrome.cast&&chrome.cast.removeReceiverActionListener(this.C);var a=m_a,b=g.La("yt.mdx.remote.debug.handlers_");g.gc(b||[],a);g.bf(this.i);g.Ow.prototype.va.call(this)};
...
this.Z("yt-remote-cast2-session-change",this.i.getScreen()),Promise.resolve(new chrome.cast.DialLaunchResponse(!1));this.re('Changing CAST intent from "'+c.receiverType+'" to "dial" for '+b.friendlyName);H8(this,new z8(this.j,b,this.B,this.config_))}b=this.i;b.N=a;b.N.appState==chrome.cast.DialAppState.RUNNING?(a=b.N.extraData||{},c=a.screenId||null,A8(b)&&a.loungeToken?a.loungeTokenRefreshIntervalMs?a=R_a(b,{name:b.i.friendlyName,screenId:a.screenId,loungeToken:a.loungeToken,dialId:b.N.receiver.label,
screenIdType:"shortLived"},a.loungeTokenRefreshIntervalMs):(g.ys(Error("No loungeTokenRefreshIntervalMs presents in additionalData: "+JSON.stringify(a)+".")),a=S_a(b,c)):a=S_a(b,c)):a=C8(b);return a};
...
g.k.zJ=function(){this.isDisposed()||(this.u=X_a(this),F8("Updating custom receivers: "+g.lj(this.u)),chrome.cast.setCustomReceivers(this.u,function(){},(0,g.Ta)(function(){this.re("Failed to set custom receivers.")},this)),this.Z("yt-remote-cast2-availability-change",G8(this)))};
...
g.k.va=function(){i0a(this);this.B=null;this.C.clear();Z8(this,null);g.Ow.prototype.va.call(this)};
...
g.k.mx=function(a){c8("CP","Cast media: "+!!a);this.i&&this.i.removeUpdateListener(this.N);if(this.i=a)this.i.addUpdateListener(this.N),j0a(this),this.Z("remotePlayerChange")};
g.k.uV=function(a){a?(j0a(this),this.Z("remotePlayerChange")):this.mx(null)};
g.k.PH=function(){f9(this,"sendDebugCommand",{debugCommand:"stats4nerds "})};
g.k.CV=function(){var a=f0a();a&&Z8(this,a)};
...
n);this.B="UNSUPPORTED";c=this.ya?"setInitialState":"setPlaylist";i9("Connecting with "+c+" and params: "+g.lj(m));this.i.connect({method:c,params:g.lj(m)},a,oZa())}else i9("Connecting without params"),this.i.connect({},a,oZa());m0a(this)};
...
p0a(this,a);a=this.pM("mlm");this.Z("multiStateLoopEnabled",a);break;case "loungeScreenDisconnected":g.hc(this.j,function(c){return"LOUNGE_SCREEN"==c.type});
p0a(this,!1);break;case "remoteConnected":var b=new a7(Z6(a.params.device));g.Xb(this.j,function(c){return c.equals(b)})||bZa(this.j,b);
break;case "remoteDisconnected":b=new a7(Z6(a.params.device));g.hc(this.j,function(c){return c.equals(b)});
break;case "gracefulDisconnect":break;case "playlistModified":r0a(this,a,"QUEUE_MODIFIED");break;case "nowPlaying":t0a(this,a);break;case "onStateChange":s0a(this,a);break;case "onAdStateChange":u0a(this,a);break;case "onVolumeChanged":v0a(this,a);break;case "onSubtitlesTrackChanged":q0a(this,a);break;case "nowAutoplaying":w0a(this,a);break;case "autoplayDismissed":this.Z("autoplayDismissed");break;case "autoplayUpNext":this.I=a.params.videoId||null;this.Z("autoplayUpNext",this.I);break;case "onAutoplayModeChanged":this.B=
a.params.autoplayMode;this.Z("autoplayModeChange",this.B);"DISABLED"==this.B&&this.Z("autoplayDismissed");break;case "onHasPreviousNextChanged":x0a(this,a);break;case "requestAssistedSignIn":this.Z("assistedSignInRequested",a.params.authCode);break;case "onLoopModeChanged":this.Z("loopModeChange",a.params.loopMode);break;default:i9("Unrecognized action: "+a.action)}};
g.k.uT=function(){var a=3;this.isDisposed()||(a=0,isNaN(this.xw())?Y7(this.i)&&isNaN(this.C)&&(a=1):a=2);return a};
g.k.Js=function(a){i9("Disconnecting with "+a);g.Ka("yt.mdx.remote.remoteClient_",null,void 0);k9(this);this.Z("beforeDisconnect",a);1==a&&m7();l_a(this.i,a);this.dispose()};
...
g.k.DY=function(a,b){n9(this,a,b);o0a(this)};
...
g.k.eW=function(){g.Df(this.B)||I0a(this,this.B);this.C=!1};
...
break;case -1:this.Wb(new g.JI(64));break;case -1E3:this.Wb(new g.JI(128,{errorCode:"mdx.remoteerror",errorMessage:"This video is not available for remote playback.",zE:2}))}a=a9(this.Vb).trackData;var b=this.B;(a||b?a&&b&&a.trackName==b.trackName&&a.languageCode==b.languageCode&&a.languageName==b.languageName&&a.kind==b.kind:1)||(this.B=a,I0a(this,a));a=a9(this.Vb);-1===a.volume||Math.round(this.G.getVolume())===a.volume&&this.G.isMuted()===a.muted||this.W.isActive()||this.LP()}else H0a(this)};
g.k.SN=function(){this.G.Z("mdxpreviousnextchange")};
g.k.bB=function(){J9(this)||H0a(this)};
...
g.k.LP=function(){var a=this;if(J9(this)){var b=a9(this.Vb);this.events.vc(this.Y);b.muted?this.G.mute():this.G.unMute();this.G.setVolume(b.volume);this.Y=this.events.S(this.G,"onVolumeChange",function(c){G0a(a,c)})}};
...
g.k.Wb=function(a){this.u.stop();var b=this.I;if(!g.OI(b,a)){var c=g.V(a,2);c!==g.V(this.I,2)&&this.G.au(c);this.I=a;K0a(this.j,b,a)}};g.w(M9,g.W);M9.prototype.hd=function(){this.i.show()};
M9.prototype.Cb=function(){this.i.hide()};
M9.prototype.j=function(){$6("mdx-privacy-popup-cancel");this.Cb()};
M9.prototype.u=function(){$6("mdx-privacy-popup-confirm");this.Cb()};g.w(N9,g.W);N9.prototype.onStateChange=function(a){J0a(this,a.state)};g.w(O9,g.pP);O9.prototype.C=function(){var a=this.G.getOption("remote","receivers");a&&1<a.length&&!this.G.getOption("remote","quickCast")?(this.Uo=g.zc(a,this.i,this),g.qP(this,g.vn(a,this.i)),a=this.G.getOption("remote","currentReceiver"),a=this.i(a),this.options[a]&&this.Zh(a),this.enable(!0)):this.enable(!1)};
O9.prototype.i=function(a){return a.key};
O9.prototype.xj=function(a){return"cast-selector-receiver"===a?"Cast...":this.Uo[a].name};
...
g.k.create=function(){var a=this.player.T(),b=g.UD(a);a={device:"Desktop",app:"youtube-desktop",loadCastApiSetupScript:a.L("mdx_load_cast_api_bootstrap_script"),enableDialLoungeToken:a.L("enable_dial_short_lived_lounge_token"),enableCastLoungeToken:a.L("enable_cast_short_lived_lounge_token")};B0a(b,a);this.subscriptions.push(g.cu("yt-remote-before-disconnect",this.rV,this));this.subscriptions.push(g.cu("yt-remote-connection-change",this.TW,this));this.subscriptions.push(g.cu("yt-remote-receiver-availability-change",this.UN,
...
g.k.load=function(){this.player.cancelPlayback();g.oM.prototype.load.call(this);this.ji=new I9(this,this.player,this.Vb);var a=(a=F0a())?a.currentTime:0;var b=F9()?new $8(z9(),void 0):null;0==a&&b&&(a=W8(a9(b)));0!==a&&this.Rb(a);K0a(this,this.Ed,this.Ed);this.player.Al(6)};
...
g.k.UN=function(){var a=[this.ql],b=a.concat,c=C0a();O8()&&g.Ex("yt-remote-cast-available")&&c.push({key:"cast-selector-receiver",name:"Cast..."});this.Uo=b.call(a,c);a=A9()||this.ql;R9(this,a);this.player.Oa("onMdxReceiversChange")};
